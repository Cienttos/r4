          ...
          <div className="p-6 md:p-8">
            <Slider {...settings}>
              {projects?.map((project, idx) => (
                <div
                  key={project.id}
                  className="border border-green-500 bg-black/80 rounded-md shadow-lg overflow-hidden flex flex-col hover:shadow-green-glow transition-all duration-300 animate-fade-in-left p-4"
