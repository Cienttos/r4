...
const testimonialData = [
    {
        ...
        role: 'Creator',
        company: 'The Matrix',
        message: 'A truly gifted mind. His ability to manipulate the very fabric of the code is... unsettling.',
        photo: 'https://via.placeholder.com/100x100.png/0f0/000?text=Architect'
    },
    {
        id: 2,
        name: 'Morpheus',
        ...
        message: 'He is the one. I have seen what he can do. He moves without limitation.',
        photo: 'https://via.placeholder.com/100x100.png/0f0/000?text=Morpheus'
    }
];
